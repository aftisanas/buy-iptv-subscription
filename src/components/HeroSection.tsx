  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-[7.5rem] lg:pt-32 pb-2 flex flex-col items-center text-center">
        ...
        >
          <span className="text-white">Buy IPTV Subscription —</span>
          <br />
          <span className="text-white">37,000 Channels In 4K, </span>
          <span className="gradient-text-hero">Streaming In 60 Seconds</span>
        </motion.h1>
