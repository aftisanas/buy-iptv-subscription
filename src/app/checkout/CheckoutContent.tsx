    ...
    <div>
      ...
      <section className="relative overflow-hidden pt-28 pb-12 lg:pt-32 lg:pb-14">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          {/* Page header */}
          <div className="mt-6">
            <div className="text-xs font-bold tracking-[0.18em] text-gold-bright">
              CHECKOUT
            </div>
            ...
            <div className="rounded-2xl border border-rule/60 bg-white p-6 shadow-lg shadow-night/5">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="shrink-0 rounded-xl bg-gradient-to-r from-gold to-gold-bright px-4 py-2.5 text-xs font-bold tracking-wider text-white transition-all hover:shadow-md hover:shadow-gold-bright/20 active:scale-[0.98]"
                >
                  APPLY
                </button>
              </div>
  ...
  if (availability.state === "available") {
    ...
    return (
      <button
        ...
        className="flex w-full items-center justify-center gap-2.5 rounded-xl bg-gold px-6 py-3.5 text-sm font-bold tracking-wide text-white transition-all hover:bg-gold-hover hover:shadow-lg hover:shadow-gold/30 active:scale-[0.99] focus-visible:outline-2 focus-visible:outline-gold-hover focus-visible:outline-offset-2 disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:bg-gold disabled:hover:shadow-none"
      >
        {submitting ? (
          <Loader2 className="h-4 w-4 animate-spin" aria-hidden="true" />
        ) : (
  ...
  if (availability.whatsappUrl) {
    return (
      <button
        ...
        className="flex w-full items-center justify-center gap-2.5 rounded-xl bg-gold px-6 py-3.5 text-sm font-bold tracking-wide text-white transition-all hover:bg-gold-hover hover:shadow-lg hover:shadow-gold/30 active:scale-[0.99] focus-visible:outline-2 focus-visible:outline-gold-hover focus-visible:outline-offset-2"
      >
